	...
	> class map  {
		...
		public:
			explicit map (const key_compare& comp = key_compare(),
				const allocator_type& alloc = allocator_type()) : _internal_tree() { }
			
			template <class InputIterator>
				map (InputIterator first, InputIterator last,
						const key_compare& comp = key_compare(), const allocator_type& alloc = allocator_type()) : _internal_tree() {
			...
			iterator			begin() const	{ return _internal_tree.begin(); }
			...
			reverse_iterator	rebgin() 		{ return _internal_tree.rbegin(); }
			// const_reverse_iterator	rebgin() const	{ return _internal_tree.rbegin(); }
